...
public class EmployeeRestController {
	...
	public Employee create(@RequestBody Employee employee) {
		...
		try {
			...
			logger.debug("suceessfully data saved in mongodb" + result);
			if (result == null)
				throw new AppException("Exception while saving data in MongoDB");
		} catch (AppException e) {
			logger.debug("exception occurred while saving data in MongoDB", e);
		}
